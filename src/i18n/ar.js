const ar = {
  ...
  footer: {
    ...
    services: 'الخدمات',
    industries: 'القطاعات',
    copyright: '© BitTech (Private) Limited. جميع الحقوق محفوظة.',
    servicesList: [
      'استشارات UI UX',
      'تصميم UI UX',
      'تصميم المواقع',
  ...
  work: {
    ...
    portfolio: [
      { name: 'بيسكوفا', title: 'تطبيق كافيه لطلب القهوة والمشروبات والوجبات الخفيفة والمفضلات اليومية.' },
      { name: 'الجوهرة', title: 'تجربة بيع بالتجزئة للمكسرات والسناكس والمنتجات الغذائية المتخصصة.' },
      { name: 'كابيلا كير', title: 'متجر تجميل ومستحضرات عناية يقدم منتجات البشرة والمكياج والعناية الذاتية.' },
      { name: 'كابيلا آب', title: 'منصة جمالية موجهة للنساء تتمحور حول مستحضرات التجميل والعناية واحتياجات أسلوب الحياة.' },
    ],
  },
  about: {
    hero: {
    ...
    partner: {
      ...
      description:
        'BitTech وكالة متخصصة في تصميم UI UX تركز على إنشاء تجارب رقمية استثنائية. نحن ملتزمون بتقديم أفضل تجربة مستخدم ممكنة لأعمالك.',
      cards: [
        {
        ...
        },
        {
          ...
          description:
            'في BitTech، يركز نهجنا على فهم احتياجات العميل والتعاون لبناء منتجات رقمية استثنائية وموجهة بالأهداف.',
        },
        {
    ...
    mission: {
      eyebrow: 'مهمتنا',
      text:
        'تسعى BitTech إلى أن تكون وكالة UI UX رائدة معروفة بحلول مبتكرة تقدم تجارب مستخدم استثنائية وتدفع نمو الأعمال. نحن نمزج بين الإبداع والتصميم المتمحور حول المستخدم لصناعة منتجات مميزة وبديهية وتحقيق أثر طويل الأمد مع عملائنا.',
  ...
  home: {
    ...
    showcase: {
      ...
      projects: [
        { image: '/storage/biscofa.png', name: 'بيسكوفا', title: 'تطبيق كافيه لطلب القهوة والمشروبات والوجبات الخفيفة والمفضلات اليومية.' },
        { image: '/storage/elgawhra.png', name: 'الجوهرة', title: 'تجربة بيع بالتجزئة للمكسرات والسناكس والمنتجات الغذائية المتخصصة.' },
        { image: '/storage/capellacare(2).png', name: 'كابيلا كير', title: 'متجر تجميل ومستحضرات عناية يقدم منتجات البشرة والمكياج والعناية الذاتية.' },
        { image: '/storage/capellacare.png', name: 'كابيلا آب', title: 'منصة جمالية موجهة للنساء تتمحور حول مستحضرات التجميل والعناية واحتياجات أسلوب الحياة.' },
      ],
    },
    discovery: {
      title: 'مشروعك هنا',
    ...
    gradient: {
      ...
      description: 'في BitTech، نبني أنظمة تصميم جاهزة للذكاء الاصطناعي لبرامج حديثة تكون مرنة وقابلة للتوسع ومتمحورة حول الإنسان.',
    ...
    faq: {
      ...
      description: 'تقلل BitTech تعقيد التصميم وتسرّع إطلاق المنتجات عبر تدفقات UX واضحة وأنظمة بصرية قابلة للتوسع وتنفيذ بدون كود.',
      ...
      items: [
        ...
        {
          question: 'كيف يختلف تصميم UI UX لدى BitTech عن الحلول الأخرى؟',
          answers: [
            'في BitTech، نؤمن بقوة التفاعل بين الإنسان والحاسوب ونستخدمه لاتخاذ قرارات تصميم مدروسة قائمة على البيانات تميزنا عن المنافسين. وبصفتنا استوديو UI UX رائدًا في باكستان، نبدأ من اكتشاف احتياجات المستخدمين ونقاط ألمهم وننتهي باختبارات حقيقية للحصول على ملاحظات مباشرة، مما يمكننا من إنشاء تصاميم تتمحور حول المستخدم وتعزز سهولة الاستخدام والوصول والرضا العام.',
        ...
        {
          question: 'هل توجد مراجعات عملاء أو دراسات حالة متاحة لتصميم UI UX لدى BitTech؟',
          answers: [
            'نفخر في BitTech بمراجعات العملاء ودراسات الحالة التي تعرض خبرتنا في مجال UI UX. يمكنك الوصول إليها بسهولة على موقعنا للاطلاع على أعمالنا والأثر الذي أحدثته في أعمال عملائنا. وبصفتنا شركة UI UX من الطراز الأول، عملنا مع مجموعة متنوعة من العملاء حول العالم وساعدناهم على إنشاء تجارب رقمية جذابة وسهلة لعملائهم.',
          ],
        },
      ],
    },
