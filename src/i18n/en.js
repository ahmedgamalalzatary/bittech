const en = {
  common: {
    ...
    form: {
      ...
      project: 'Tell us about your project, goals, timeline, or requirements*',
      submit: 'Submit Inquiry',
      preferEmail: 'Prefer email instead? Feel free to contact us directly.',
    },
    contact: {
      eyebrow: 'Contact us',
  ...
  about: {
    ...
    team: {
      ...
      members: [
        ...
        { image: '/frontend-assets/images/about-babar.webp', name: 'Muhammad Babar', role: 'Design Director' },
        { image: '/frontend-assets/images/about-umar.webp', name: 'Umar Islam', role: 'UI UX Design Lead' },
        { image: '/frontend-assets/images/about-nashra.webp', name: 'Nashra Maqsood', role: 'UI UX Designer' },
        { image: '/frontend-assets/images/about-gohar.webp', name: 'Goher Ayub', role: 'UI UX Designer' },
        { image: '/frontend-assets/images/about-abdullah.webp', name: 'Rao Abdullah', role: 'UI UX Designer' },
        { image: '/frontend-assets/images/about-maryam.webp', name: 'Mariam Hashmi', role: 'UI UX Designer' },
        { image: '/frontend-assets/images/about-mubashir.webp', name: 'Rana Mubashir', role: 'UI UX Designer' },
        { image: '/frontend-assets/images/about-yousaf.webp', name: 'Muhammad Yousaf', role: 'UI UX Designer' },
        { image: '/frontend-assets/images/about-mustafa.webp', name: 'Mustafa Afridi', role: 'UI UX Designer' },
        { image: '/frontend-assets/images/about-bilal.webp', name: 'Bilal Younas', role: 'UI UX Designer' },
      ],
    },
    reviews: {
      reviewCount: '41 Reviews',
      platforms: 'Reviews on 3 platforms',
